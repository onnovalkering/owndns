...
- Use the new two-part threat intelligence feed (TIF) blocklist.

### Updated

- Updated `nixpkgs` channel to 26.05, and in turn Unbound to v1.25.1.
- Use updated CDN URL for the newly-registered domains (NRD) blocklist.
